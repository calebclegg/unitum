...
exports.validateCommentCreateData = exports.validatePostEditData = exports.validatePostCreateData = void 0;
...
exports.validatePostEditData = validatePostEditData;
const validateCommentCreateData = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const Schema = joi_1.default.object({
        text: joi_1.default.string().required()
    });
    return Schema.validate(data);
});
exports.validateCommentCreateData = validateCommentCreateData;
